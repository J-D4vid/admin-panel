...
function createQuestionCard(obj) {
    ...
    form.innerHTML += `
    <label for="alternative" class="q-option a1">
    <input type="checkbox" name="alternative" class="qopt "> ${obj.alt1} 
    </label>`

    form.innerHTML += `
    <label for="alternative" class="q-option a2">
    <input type="checkbox" name="alternative" class="qopt "> ${obj.alt2} 
    </label>`

    form.innerHTML += `
    <label for="alternative" class="q-option a3">
    <input type="checkbox" name="alternative" class="qopt "> ${obj.alt3} 
    </label>`

    form.innerHTML += `
    <label for="alternative" class="q-option a4">
    <input type="checkbox" name="alternative" class="qopt "> ${obj.alt4} 
    </label>`

    form.innerHTML += `
    <label for="alternative" class="q-option ac">
    <input type="checkbox" name="alternative" class="qopt "> ${obj.alt_correta} 
    </label>`
    
    form.innerHTML += `<div class="buttons">
    <input type="submit" value="Enviar" class="send quest">
    <input type="submit" value="Excluir" class="send delete_question" >
    </div>`
