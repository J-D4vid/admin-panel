class QuestionController {
    ...
    activateInteractions() {
        ...
        const sendquestion = document.querySelectorAll('.quest')
        this.MostrarAlternativas(sendquestion)
    ...
    MostrarAlternativas(elements){
        elements.forEach((quest)=>{
            quest.addEventListener('click',(e)=>{
                e.preventDefault()
                const closestCard = quest.closest('form')
                const alt1 = closestCard.querySelector('.a1');
                const alt2 = closestCard.querySelector('.a2');
                const alt3 = closestCard.querySelector('.a3');
                const alt4 = closestCard.querySelector('.a4');
                const altc = closestCard.querySelector('.ac');

                alt1.style.color = "red";
                alt2.style.color = "red";
                alt3.style.color = "red";
                alt4.style.color = "red";
                altc.style.color = "green";
            })
        })
    }
